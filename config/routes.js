...
module.exports.routes = {
  ...
  "DELETE /feeditem/:postId": { action: "feeditem/delete" },
  "POST /like/:postId": { action: "feeditem/like" },
  "POST /dislike/:postId": { action: "feeditem/dislike" },
  "GET /likes/:postId": { action: "post/likes" },
  ...
  "GET /friends": { action: "user/friends" },
  "GET /customauth/login": {
    action: "customauth/view-login",
    locals: {
